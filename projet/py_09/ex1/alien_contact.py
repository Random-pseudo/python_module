...
def main() -> None:
    ...
    valid_contact: AlienContact = AlienContact(
        ...
        timestamp=datetime.fromisoformat("2024-03-20T22:15:00"),
    ...
    try:
        AlienContact(
            ...
            timestamp=datetime.fromisoformat("2024-03-21T03:00:00"),
    ...
    try:
        AlienContact(
            ...
            timestamp=datetime.fromisoformat("2024-03-22T10:00:00"),
            location="Roswell, NM",
